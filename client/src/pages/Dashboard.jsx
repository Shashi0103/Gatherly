        ...
        <AnimatePresence>
          {success && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -20 }}
              className="fixed top-6 right-12 z-50 py-3 px-5 rounded-glass bg-greenAccent/10 border border-greenAccent/20 text-greenAccent-light text-xs font-semibold shadow-lg shadow-greenAccent/5 flex items-center gap-2"
            >
